...
#define USB_NUMTARGETS  5       //number of targets in TPL, not counting uninitialized device
...
#define MSD             4       //Mass storage class driver number in DEV_RECORD
#define HID_G			3
...
#define HID_PROTOCOL_GAMEPAD        0x03
